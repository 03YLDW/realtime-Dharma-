...
public class DbusUserInfo6BaseLabel2Kafka {
    ...
    private static final String kafka_label_base6_topic = "base6_topic";
    private static final String kafka_label_base4_topic = "base4_topic";
    private static final String kafka_label_base2_topic = "base2_topic";
...
//                .sinkTo(
//                        KafkaUtils.buildKafkaSink(kafka_botstrap_servers,"base6_topic")
//                );

        mapOrderInfoAndDetailModelDs.map(data -> data.toJSONString())
                .sinkTo(
                        KafkaUtils.buildKafkaSink(kafka_botstrap_servers,"base4_topic")
                );

//        mapDeviceAndSearchRateResultDs.map(data -> data.toJSONString())
//                .sinkTo(
//                        KafkaUtils.buildKafkaSink(kafka_botstrap_servers,"base2_topic")
//                );
